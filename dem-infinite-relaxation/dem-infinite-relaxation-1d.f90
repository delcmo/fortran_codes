...
!     kprint : printing frequency
      integer(kind=8), parameter:: kmax=2000000
...
!               updated each time step in subroutine Derv
      double precision :: cmax=0.d0,temps=0.d0,temps_end=1.d-1
!
!~~~~~~~~~~~~~~~~~~ GEOMETRY ~~~~~~~~~~~~~~~~~~~~~~~~~~~
!     tube length
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      if (mod(k,kprint).eq.0)then
         print*,'iter',k, 'time',temps, 'dt',dt, 'cmax', cmax, 'norm stt residual', dt*norm2(rhs)
         call Print_Results(k)
      endif
!	  if (k.gt.142800)then
